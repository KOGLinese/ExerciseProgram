================================================================================
    MICROSOFT 基础类库 : sb 项目概述
===============================================================================

应用程序向导已为您创建了此 sb 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
sbDlg.h、sbDlg.cpp - 对话框
    这些文件包含 CsbDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 sb.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
